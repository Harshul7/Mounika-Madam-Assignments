...
%h :directory path
sort:sorts the directory paths in alphabetical order
...
# we are extracting only the directory name
  #dir="${dir##*/}"
...
${file#./} -parameter expansion that removes the shortest match of ./ from thebeginning of $file
ex:
./file1.txt -->file1.txt
./file2.txt -->file2.txt
...
#we are extracting only the file name
    file=${file##*/}
    echo ">$file"
done